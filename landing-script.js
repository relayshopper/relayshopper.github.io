...
async function handleFormSubmission(event) {
    ...
    if (isFormValid) {
        ...
        try {
            ...
            const scriptURL = 'https://script.google.com/macros/s/AKfycbw-E6Ha6EXxtDQxc4eMfLRJjSKHVP8N3a02mELEpVwAttbtHjzQ62ra45ZqpJFDUxaIAg/exec';
            ...
            showErrorMessage('There was an error submitting your application. Please try again or contact support.');
        } finally {
            // Reset button
...
function showSuccessMessage() {
    ...
    // User can manually navigate away or we can add a redirect option
}
